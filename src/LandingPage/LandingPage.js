...
export default function LandingPage() {
    return (
        <div>
            ...
            <Section2 />
            <Section3 />
            {/* <SectionDivider Header='Kunaa Pay Accepts Multiple Payment Methods' Body='Grow your business, go global, and boost transaction success rates by giving your customers multiple choice of payment.' /> */}
